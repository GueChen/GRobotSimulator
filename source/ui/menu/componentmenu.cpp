	...
	QMenu(parent)
{
    ...
    m_joint_component         = m_add_component_menu->addAction("Joint Component");       //                  || Joint Component
    m_joint_group_component   = m_add_component_menu->addAction("Joint Group Component"); //                  || Joint Group Component
    m_kinematic_component     = m_add_component_menu->addAction("Kinematic Component");   //                  || Kinematic Component
    m_tracker_component       = m_add_component_menu->addAction("Tracker Component");     // 
}
